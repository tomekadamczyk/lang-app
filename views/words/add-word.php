      ...
      <div class="modal-body">
        <div class="addWord">
            <form action="" method="POST">
                <input type="text" class="form-control my-2" id="slowo" name="slowo" placeholder="Dodaj nowe słowo czeskie">
                <input type="text" class="form-control my-2" id="tlumaczenie" name="tlumaczenie" placeholder="Wpisz polskie tłumaczenie">
                <textarea class="form-control my-2" name="definicja" placeholder="Wpisz definicję nowego słowa w języku czeskim"></textarea>
