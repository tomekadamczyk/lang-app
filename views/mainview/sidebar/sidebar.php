...
<div class="logo-transformed">
    ...
    <div class="cz-sidebar-link">
        <a href="#" class="cz-sidebar-link__item"><i class="fas fa-graduation-cap"></i>Ćwiczenia</a>
        <div class="cz-sidebar-link-dropdown">
            <div class="cz-sidebar-link-dropdown-link">
                <a href="index.php?id=1" class="cz-sidebar-link-dropdown__item"><i class="fas fa-layer-group"></i>Fiszki</a>
            </div>
            <div class="cz-sidebar-link-dropdown-link">
                <a href="index.php?id=2" class="cz-sidebar-link-dropdown__item"><i class="far fa-keyboard"></i>Wisielec</a>
            </div>
        </div>
    </div>
    <div class="cz-sidebar-link">
        <a href="#" class="cz-sidebar-link__item"><i class="fas fa-user-graduate"></i>Testy</a>
        <div class="cz-sidebar-link-dropdown">
            <div class="cz-sidebar-link-dropdown-link">
                <a href="index.php?id=6" class="cz-sidebar-link-dropdown__item"><i class="fas fa-layer-group"></i>Fiszki</a>
            </div>
        </div>
    </div>
    <div class="cz-sidebar-link">
